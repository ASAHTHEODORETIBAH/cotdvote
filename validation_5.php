...
$sql = "SELECT candidate,count(*) as result from  `users_5th` group by candidate";
...
<head>
    ...
    <title>Sports Coordinator Results</title>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card-5">
            <h2><strong  class="hh"> Sports Coordinator Results</strong></h2>
            <hr>
