...
$sql = "SELECT candidate,count(*) as result from  `users_6th` group by candidate";
...
<head>
    ...
    <title>Financial Secretary Results</title>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card-5">
            <h2><strong  class="hh"> Financial Secretary Results</strong></h2>
            <hr>
