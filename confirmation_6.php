    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" ><br>
                <form action="SavedData_6.php" method="post" id=ConfirmForm> 
                   <h1 style="font-family:'time new roman'; color:teal">Confirm Financial Secretary</h1><hr>
            ...
            <?php 
        $sql = "select name from candidate_6th where approve_status=1";
        ...
        <?php }?>
                    ...
                    <tr>
                        <td class="td-2" id style="padding-top: 20px; padding-bottom: 40px;" ><button class="magnifyBtn" name="Submit">Confirm</button></td>
                    </tr>
                </table>
              </form>
            </div>
