    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" ><br>
                <form action="SavedData_5.php" method="post" id=ConfirmForm> 
                   <h1 style="font-family:'time new roman'; color:teal">Confirm Sports Coordinator</h1><hr>
            ...
            <?php 
        $sql = "select name from candidate_5th where approve_status=1";
