        ...
        <div class="row">
            <div class="col-md-6" >
              <br><br>
                ...
                <form action="process_cand.php" method="post" enctype="multipart/form-data"><br>
                  <h2 class="h2_1">Apply As President</h2><hr>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="td-1"><input   required type="text" style="text-align: left;" name="txtMat"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="td-1"><input  required type="file" style="width:13em;" name="txtPhoto"></td>
                    </tr>
                    
                    <tr>
                        <td class="td-2" id style="padding-top: 20px; padding-bottom: 40px;" ><button class="magnifyBtn" type="" name="Submit">Apply</button></td>
                    </tr>
                </table>
              </form>
            </div>
