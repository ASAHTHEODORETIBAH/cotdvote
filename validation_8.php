...
$sql = "SELECT candidate,count(*) as result from  `users_8th` group by candidate";
...
<head>
    ...
    <title>Academic Officer Results</title>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card-5">
            <h2><strong  class="hh">Academic Officer Results</strong></h2>
            <hr>
